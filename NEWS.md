...
### Working Examples and Sample Data
* Added built-in sample datasets (~150KB) to `inst/extdata/`
* New `download_sample_data()`, `get_sample_data()`, `list_sample_datasets()`,
  and `load_sample_data()` helper functions
...
* Full R CMD check passes cleanly: 0 errors | 0 warnings | 0 notes
